...
class Model(ModelDesc):
    ...
    def build_graph(self, image, label):
        ...
        bottleneck = {'resnet': resnet_bottleneck}[mode]
        num_blocks, block_func = [3,4,6,3], bottleneck
        ...
        with argscope([Conv2D, AvgPooling, BatchNorm, GlobalAvgPooling], data_format='channels_first'), \
            ...
            logits =  resnet_backbone(image, num_blocks, resnet_group, block_func)
    ...
    config = TrainConfig(
        ...
        callbacks=[
            ...
            ScheduledHyperParamSetter('learning_rate',
                                      [(1, 0.1), (30, 0.01), (55, 0.001), (80, 0.0002)])
        ],
        max_epoch=100,
