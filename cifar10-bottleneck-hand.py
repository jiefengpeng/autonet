        ...
        def dense_net(name):
            ...
            with tf.variable_scope('block1') as scope:
                ...
                for i in range(self.N):
                    l = add_bottleneck('dense_bottleneck.{}'.format(i), l, mask, 16, increase_dim=True if i == (self.N-1) else False, pool=False)
...
def get_config():
    log_dir = 'train_log/cifar10-bottleneck-hand-conv1-N%s-L%s-K%s-B%s' % (str(BOTTLE_NUM), str(LAYER_NUM), str(KERNEL), '5')
    ...
    callbacks=[
        ...
        ScheduledHyperParamSetter('learning_rate',
                                  [(2, 0.001), (args.drop_1, 0.01), (args.drop_2, 0.001)]),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_epoch',default=77,help='max epoch')
